...
extern inline int8_t py_sign_type_int8(int8_t x);
extern inline int16_t py_sign_type_int16(int16_t x);
extern inline int32_t py_sign_type_int32(int32_t x);
extern inline int64_t py_sign_type_int64(int64_t x);
