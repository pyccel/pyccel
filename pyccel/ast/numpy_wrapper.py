...
PyArray_DATA = FunctionDef(
    ...
    arguments=[
        FunctionDefArgument(
            Variable(PyccelPyArrayObject(), name="o", memory_handling="alias")
        )
    ],
...
PyArray_DATA = FunctionDef(
    ...
    arguments=[
        FunctionDefArgument(
            Variable(PyccelPyArrayObject(), "arr", memory_handling="alias")
        )
    ],
...
PyArray_SetBaseObject = FunctionDef(
    ...
    arguments=[
        FunctionDefArgument(
            Variable(PyccelPyArrayObject(), name="arr", memory_handling="alias")
        ),
        FunctionDefArgument(
            Variable(PyccelPyObject(), name="obj", memory_handling="alias")
        ),
    ],
...
to_pyarray = FunctionDef(
    ...
    results=FunctionDefResult(
        Variable(PyccelPyObject(), name="arr", memory_handling="alias")
    ),
)
