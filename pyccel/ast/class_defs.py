...
ComplexClass = ClassDef(
    "complex",
    class_type=PythonNativeComplex(),
    methods=[
        PyccelFunctionDef(
            "imag",
...
BooleanClass = ClassDef(
    "boolean", class_type=PythonNativeBool(), superclasses=(IntegerClass,)
)
...
NumpyArrayClass = ClassDef(
    ...
    methods=[
        ...
        PyccelFunctionDef(
            "sum", func_class=NumpySum, decorators={"numpy_wrapper": "numpy_wrapper"}
        ),
        PyccelFunctionDef(
            "min", func_class=NumpyAmin, decorators={"numpy_wrapper": "numpy_wrapper"}
        ),
        PyccelFunctionDef(
            "max", func_class=NumpyAmax, decorators={"numpy_wrapper": "numpy_wrapper"}
        ),
        PyccelFunctionDef(
            "imag",
        ...
        PyccelFunctionDef(
            "copy",
            func_class=NumpyArray,
            argument_description={"self": None, "order": "C"},
            decorators={"numpy_wrapper": "numpy_wrapper"},
        ),
    ],
)
