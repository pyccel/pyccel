    ...
    def __init__(self, set_obj, *others):
        ...
        for o in others:
            if element_type != o.class_type.element_type:
                raise TypeError(
                    f"Argument of type {o.class_type} cannot be used to build set of type {self._class_type}"
                )
    ...
    def __init__(self, set_obj, *others):
        ...
        for o in others:
            if class_type != o.class_type:
                raise TypeError(
                    f"Only arguments of type {class_type} are supported for the functions intersection and .intersection_update"
                )
        super().__init__(set_obj, *others)
...
class SetIsDisjoint(SetMethod):
    ...
    def __init__(self, set_obj, other_set_obj):
        if set_obj.class_type != other_set_obj.class_type:
            raise TypeError(
                "Is disjoint can only be used to compare sets of the same type."
            )
