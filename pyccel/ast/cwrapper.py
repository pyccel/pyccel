...
PyErr_Occurred = FunctionDef(
    ...
    arguments=[],
    results=FunctionDefResult(
        Variable(PyccelPyObject(), name="r", memory_handling="alias")
    ),
    body=[],
)
...
PyErr_SetString = FunctionDef(
    ...
    body=[],
    arguments=[
        FunctionDefArgument(Variable(PyccelPyObject(), name="o")),
...
PyObject_TypeCheck = FunctionDef(
    ...
    arguments=[
        FunctionDefArgument(Variable(PyccelPyObject(), "o", memory_handling="alias")),
        FunctionDefArgument(
            Variable(PyccelPyClassType(), "c_type", memory_handling="alias")
        ),
    ],
...
PyList_Append = FunctionDef(
    ...
    arguments=[
        FunctionDefArgument(
            Variable(PyccelPyObject(), "list", memory_handling="alias")
        ),
        FunctionDefArgument(
            Variable(PyccelPyObject(), "item", memory_handling="alias")
        ),
    ],
...
PyList_Size = FunctionDef(
    name="PyList_Size",
    arguments=[
        FunctionDefArgument(Variable(PyccelPyObject(), "list", memory_handling="alias"))
    ],
...
PyList_SetItem = FunctionDef(
    ...
    arguments=[
        FunctionDefArgument(
            Variable(PyccelPyObject(), name="l", memory_handling="alias")
        ),
        FunctionDefArgument(Variable(PythonNativeInt(), name="i")),
        FunctionDefArgument(
            Variable(PyccelPyObject(), name="new_item", memory_handling="alias")
        ),
    ],
    results=FunctionDefResult(Variable(CNativeInt(), "i")),
)
...
PyTuple_New = FunctionDef(
    ...
    results=FunctionDefResult(
        Variable(PyccelPyObject(), "tuple", memory_handling="alias")
    ),
    body=[],
)
...
PyTuple_GetItem = FunctionDef(
    ...
    arguments=[
        FunctionDefArgument(
            Variable(PyccelPyObject(), name="tuple", memory_handling="alias")
        ),
        FunctionDefArgument(Variable(PythonNativeInt(), name="i")),
    ],
    results=FunctionDefResult(
...
PySet_New = FunctionDef(
    ...
    arguments=[
        FunctionDefArgument(
            Variable(PyccelPyObject(), "iterable", memory_handling="alias"), value=Nil()
        )
    ],
    results=FunctionDefResult(
        Variable(PyccelPyObject(), "set", memory_handling="alias")
    ),
    body=[],
)
...
PySet_Add = FunctionDef(
    name="PySet_Add",
    arguments=[
        FunctionDefArgument(Variable(PyccelPyObject(), "set", memory_handling="alias")),
...
PyObject_GetIter = FunctionDef(
    ...
    arguments=[
        FunctionDefArgument(
            Variable(PyccelPyObject(), name="iter", memory_handling="alias")
        )
    ],
    results=FunctionDefResult(
        Variable(PyccelPyObject(), name="o", memory_handling="alias")
...
PySet_Clear = FunctionDef(
    ...
    arguments=[
        FunctionDefArgument(
            Variable(PyccelPyObject(), name="set", memory_handling="alias")
        )
    ],
    results=FunctionDefResult(Variable(PythonNativeInt(), "i")),
)
...
PyDict_New = FunctionDef(
    ...
    arguments=[],
    results=FunctionDefResult(
        Variable(PyccelPyObject(), "dict", memory_handling="alias")
    ),
    body=[],
)
...
PyUnicode_AsUTF8 = FunctionDef(
    ...
    arguments=[
        FunctionDefArgument(
            Variable(PyccelPyObject(), "unicode", memory_handling="alias")
        )
    ],
...
PyUnicode_Check = FunctionDef(
    ...
    arguments=[
        FunctionDefArgument(Variable(PyccelPyObject(), "str", memory_handling="alias"))
    ],
