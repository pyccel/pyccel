...
class CCodePrinter(CodePrinter):
    ...
    def __init__(self, parser, settings=None):
        ...
        self._unused_return_variable = None
    ...
    def _print_FunctionDef(self, expr):
        ...
        if len(expr.results) == 1 :
            if isinstance(expr.results[0], Variable) and expr.results[0] != self._unused_return_variable:
    ...
    def _print_Return(self, expr):
        ...
        if len(args) == 1:
            if expr.stmt:
                self._unused_return_variable = expr.stmt.body[0].lhs
