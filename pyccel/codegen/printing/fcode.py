    ...
    def _print_PythonPrint(self, expr):
        ...
        for i, f in enumerate(orig_args):
            if f.keyword:
                ...
                f = f.value
            if isinstance(f, str) or isinstance(f, PythonTuple) or isinstance(f, InhomogeneousTupleVariable):
    ...
    def _wrap_fortran(self, lines):
        ...
        for line in lines:
            if len(line) > 72 and '!' in line[:72]:
                ...
                for l, r in inside_quotes_intervals:
                    for x in range(l, r):
                        inside_quotes_positions.add(x)
