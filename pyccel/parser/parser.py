...
#==============================================================================
    ...
    def _annotate_list(self, expr, **settings):
        ls = [self._annotate(i, **settings) for i in expr]
        return Tuple(*ls, sympify=False)

    def _annotate_tuple(self, expr, **settings):
        ls = [self._annotate(i, **settings) for i in expr]
        return Tuple(*ls, sympify=False)
    ...
    def _annotate_CodeBlock(self, expr, **settings):
        return expr
    def _annotate_Nil(self, expr, **settings):
        return expr
    def _annotate_ValuedArgument(self, expr, **settings):
        return expr
    def _annotate_EmptyLine(self, expr, **settings):
        return expr
    def _annotate_NewLine(self, expr, **settings):
        return expr
    def _annotate_Break(self, expr, **settings):
        return expr
    def _annotate_Continue(self, expr, **settings):
        return expr
    def _annotate_Comment(self, expr, **settings):
        return expr
    def _annotate_CommentBlock(self, expr, **settings):
        return expr
    def _annotate_AnnotatedComment(self, expr, **settings):
        return expr
    def _annotate_Integer(self, expr, **settings):
        return expr
    def _annotate_Float(self, expr, **settings):
        return expr
    def _annotate_String(self, expr, **settings):
        return expr
    def _annotate_ImaginaryUnit(self, expr, **settings):
        return expr
    def _annotate_BooleanTrue(self, expr, **settings):
        return expr
    def _annotate_BooleanFalse(self, expr, **settings):
        return expr
    ...
    def _annotate_Number(self, expr, **settings):
        return expr.n()	

    def _annotate_Variable(self, expr, **settings):
        name = expr.name
        var = self.get_variable(name)
        if var is None:
    ...
    def _annotate_str(self, expr, **settings):
        return repr(expr)

    def _annotate_Slice(self, expr, **settings):
        args = list(expr.args)
    ...
    def _annotate_Indexed(self, expr, **settings):
        name = _get_name(expr)
        var = self.get_variable(name)
        if var is None:
    ...
    def _annotate_Symbol(self, expr, **settings):
        name = expr.name
        var = self.get_variable(name)
    ...
    def _annotate_DottedVariable(self, expr, **settings):
    ...
    def _annotate_Add(self, expr, **settings):
    ...
    def _annotate_Pow(self, expr, **settings):
    ...
    def _annotate_And(self, expr, **settings):
    ...
    def _annotate_Or(self, expr, **settings):
    ...
    def _annotate_Equality(self, expr, **settings):
    ...
    def _annotate_Unequality(self, expr, **settings):
    ...
    def _annotate_StrictLessThan(self, expr, **settings):
    ...
    def _annotate_GreaterThan(self, expr, **settings):
    ...
    def _annotate_LessThan(self, expr, **settings):
    ...
    def _annotate_StrictGreaterThan(self, expr, **settings):
    ...
    def _annotate_Lambda(self, expr, **settings):
    ...
    def _annotate_Application(self, expr, **settings):
    ...
    def _annotate_Expr(self, expr, **settings):
...
#                   d_var = None
    ...
    def _annotate_FunctionalFor(self, expr, **settings):
    ...
    def _annotate_FunctionHeader(self, expr, **settings):
        # TODO should we return it and keep it in the AST?
        self.insert_header(expr)
        return expr

    def _annotate_ClassHeader(self, expr, **settings):
        # TODO should we return it and keep it in the AST?
        self.insert_header(expr)
        return expr

    def _annotate_InterfaceHeader(self, expr, **settings):
    ...
    def _annotate_Return(self, expr, **settings):
        ...
        if len(assigns) == 0:
            ...
            new_vars = [self._annotate_Symbol(i, **settings) for i in
                        new_vars]
            assigns  = CodeBlock(assigns)
            return Return(new_vars, assigns)

    def _annotate_FunctionDef(self, expr, **settings):
...
#            raise ValueError('all arguments must be either symbolic or none of them')
    ...
    def _annotate_ClassDef(self, expr, **settings):
    ...
    def _annotate_Import(self, expr, **settings):
    ...
    def _annotate_MacroFunction(self, expr, **settings):
    ...
    def _annotate_MacroVariable(self, expr, **settings):
    ...
    def _annotate_Dlist(self, expr, **settings):
