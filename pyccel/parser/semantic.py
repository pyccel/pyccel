...
from pyccel.errors.messages import (PYCCEL_RESTRICTION_TODO, UNDERSCORE_NOT_A_THROWAWAY,
        ...
        INVALID_MACRO_COMPOSITION, UNSUPPORTED_POINTER_RETURN_VALUE, WRONG_NUMBER_OUTPUT_ARGS, INVALID_FOR_ITERABLE,
        ...
        UNSUPPORTED_ARRAY_POINTER_VALUE, PYCCEL_MISSING_HEADER, PYCCEL_RESTRICTION_OPTIONAL_NONE,
