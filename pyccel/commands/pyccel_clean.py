...
def pyccel_clean(
    path_dir=None, recursive=True, remove_shared_libs=False, remove_programs=False
):
    """
    ...
    if path_dir is None:
        ...
        for f in path_dir:
            pyccel_clean(
                f,
                recursive=recursive,
                remove_shared_libs=remove_shared_libs,
...
def pyccel_clean_command():
    ...
    parser = ArgumentParser(
        description="Tool for removing files generated by pyccel", add_help=False
    )
