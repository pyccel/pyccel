...
Although the semantic layer usually takes care of creating all variables necessary it is occasionally necessary to create a variable in the code generation stage (e.g. The iteration index used when printing an array).
