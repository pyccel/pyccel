...
-   Each category of object has an accessor property (e.g. `Scope.variables`) which can be used to get, for example, all the variables in the current scope (this function only relates to the exact scope not the enclosing scopes).
