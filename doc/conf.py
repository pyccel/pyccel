# -*- coding: utf-8 -*-
#
# Pyccel documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'Pyccel.tex', u'Pyccel Documentation',
     u'A. Ratnani', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyccel', u'Pyccel Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Pyccel', u'Pyccel Documentation',
     author, 'Pyccel', 'One line description of project.',
     'Miscellaneous'),
]
