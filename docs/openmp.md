...
[*OpenMP 4.5 API Specification (pdf)*](https://www.openmp.org/wp-content/uploads/openmp-4.5.pdf)\
[*OpenMP 5.0 API Specification (pdf)*](https://www.openmp.org/wp-content/uploads/OpenMP-API-Specification-5.0.pdf)
