...
def test_array_assigned_dtype(language):
    integer   = randint(low = iinfo('int').min,   high = iinfo('int').max)
...
def test_dtype_conversion_to_bool_from_other_types(language):
    ...
    integer   = np.array(randint(low = iinfo('int').min,   high = iinfo('int').max, size = size), dtype=int)
...
def test_src_dest_array_diff_sizes_dtype_conversion_to_bool(language):
    ...
    integer_1 = np.array(randint(low = iinfo('int').min, high = iinfo('int').max , size = size), dtype=int)
    integer_2 = np.array(randint(low = iinfo('int').min, high = iinfo('int').max , size = size), dtype=int)
    integer_3 = np.array(randint(low = iinfo('int').min, high = iinfo('int').max , size = size), dtype=int)
