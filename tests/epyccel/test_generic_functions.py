...
def test_float_types(language):
    ...
    assert f1(np.float32(155.2), np.float32(177.1)) == f2(
        np.float32(155.2), np.float32(177.1)
    )
    assert f1(np.float64(166.6), np.float64(255.6)) == f2(
        np.float64(166.6), np.float64(255.6)
    )
...
def test_complex_types(language):
    ...
    assert f1(np.complex128(15.5 + 2.0j), np.complex128(10.5 + 3.4j)) == f2(
        np.complex128(15.5 + 2.0j), np.complex128(10.5 + 3.4j)
    )
    assert f1(np.complex64(15.5 + 2.0j), np.complex64(10.5 + 3.4j)) == f2(
        np.complex64(15.5 + 2.0j), np.complex64(10.5 + 3.4j)
    )
...
def test_mix_types_1(language):
    ...
    assert f1(complex(1, 2), np.float64(7.0), np.int16(5)) == f2(
        complex(1, 2), np.float64(7.0), np.int16(5)
    )
    assert f1(complex(1, 2), np.float64(7.0), False) == f2(
        complex(1, 2), np.float64(7.0), False
    )
    assert f1(15, 14, np.int16(2012)) == f2(15, 14, np.int16(2012))
    assert f1(15, 14, True) == f2(15, 14, True)
    assert f1(15, np.float64(7.0), np.int16(2012)) == f2(
        15, np.float64(7.0), np.int16(2012)
    )
...
def test_mix_types_2(language):
    ...
    assert f1(complex(7.2, 3.12), complex(7.2, 3.12)) == f2(
        complex(7.2, 3.12), complex(7.2, 3.12)
    )
...
@pytest.mark.parametrize(
    ...
    (
        pytest.param(
            "fortran",
            marks=[pytest.mark.xfail(reason="Issue #1339"), pytest.mark.fortran],
        ),
        pytest.param("c", marks=pytest.mark.c),
