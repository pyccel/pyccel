...
def test_numpy_complex64_array_like_1d(language):
    ...
    assert epyccel_func(bl) == get_complex64(bl)
    assert epyccel_func(integer8) == get_complex64(integer8)
    assert epyccel_func(integer16) == get_complex64(integer16)
    assert epyccel_func(integer) == get_complex64(integer)
    assert epyccel_func(integer32) == get_complex64(integer32)
    # the if block should be removed after resolving (https://github.com/pyccel/pyccel/issues/735).
    if sys.platform != 'win32':
...
def test_numpy_complex128_array_like_1d(language):
    ...
    assert epyccel_func(bl) == get_complex128(bl)
    assert epyccel_func(integer8) == get_complex128(integer8)
    assert epyccel_func(integer16) == get_complex128(integer16)
    assert epyccel_func(integer) == get_complex128(integer)
    assert epyccel_func(integer32) == get_complex128(integer32)
    # the if block should be removed after resolving (https://github.com/pyccel/pyccel/issues/735).
    if sys.platform != 'win32':
