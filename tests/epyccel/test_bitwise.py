...
def test_right_shift_b_b(experimental_language, a, b):
...
def test_right_shift_i_i(experimental_language, a, b):
...
def test_right_shift_b_i(experimental_language, a, b):
...
def test_left_shift_b_i(experimental_language, a, b):
    f1 = bitwise.right_shift_b_i
    f2 = epyccel(f1, language=experimental_language)
    r1 = f1(a, b)
    r2 = f2(a, b)
...
@pytest.mark.parametrize("a, b", [(1, 1), (1, 2)])
def test_left_shift_i_i(experimental_language, a, b):
    f1 = bitwise.right_shift_i_i
    f2 = epyccel(f1, language=experimental_language)
    r1 = f1(a, b)
    r2 = f2(a, b)
...
@pytest.mark.parametrize("a, b", [(True, False), (True, True)])
def test_left_shift_b_b(experimental_language, a, b):
    f1 = bitwise.right_shift_b_b
    f2 = epyccel(f1, language=experimental_language)
    r1 = f1(a, b)
    r2 = f2(a, b)
...
def test_bit_xor_b_b_b(experimental_language, a, b, c):
...
@pytest.mark.parametrize("a, b", [(1, 1), (1, 2)])
def test_bit_xor_i_i(experimental_language, a, b):
...
def test_bit_xor_b_i(experimental_language, a, b):
...
def test_bit_or_i_b(experimental_language, a, b):
...
@pytest.mark.parametrize("a, b", [(1, 1), (1, 2)])
def test_bit_or_i_i(experimental_language, a, b):
...
def test_bit_and_i_b(experimental_language, a, b):
...
@pytest.mark.parametrize("a, b", [(1, 1), (1, 2)])
def test_bit_and_i_i(experimental_language, a, b):
...
def test_bit_and_i_i_i(experimental_language, a, b, c):
...
def test_bit_and_b_b_i(experimental_language, a, b, c):
...
def test_invert_b(experimental_language):
    f1 = bitwise.invert_b
    f2 = epyccel(f1, language=experimental_language)
    for a in [True, False]:
        r1 = f1(a)
