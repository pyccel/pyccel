...
tuple_funcs = [
    (f, getattr(tuples_module, f))
    for f in tuples_module.__all__
...
@pytest.mark.parametrize(
    "test_func", [tuples_module.tuple_unpacking_3, tuples_module.tuple_unpacking_4]
)
...
@pytest.mark.parametrize(
    ...
    (
        ...
        pytest.param(
            ...
            marks=[
                pytest.mark.skip(
                    reason="Returning tuples from functions requires a reorganisation of the return system. See #337"
                ),
                pytest.mark.c,
            ],
        ),
