...
import pytest
from modules import division, epyccel_floor_division
...
# Separate fixture used as division raises conversion warnings
@pytest.fixture(scope="module")
def epyc_division_mod(language):
    return epyccel_module_with_fallback(division, language)


@pytest.fixture(scope="module")
def epyc_floor_division_mod(language):
...
def test_call_div_i_i(epyc_division_mod):
    div_i_i = division.div_i_i
    f = epyc_division_mod.div_i_i
    x = randint(1e9)
...
def test_call_div_i_r(epyc_division_mod):
    div_i_r = division.div_i_r
    f = epyc_division_mod.div_i_r
    x = randint(1e9)
...
def test_call_div_r_i(epyc_division_mod):
    div_r_i = division.div_r_i
    f = epyc_division_mod.div_r_i
    x = uniform(high=1e9)
    y = randint(low=1, high=1e3)
...
def test_call_div_r_r(epyc_division_mod):
    div_r_r = division.div_r_r
    f = epyc_division_mod.div_r_r
    x = uniform(high=1e9)
...
def test_call_div_c_c(epyc_division_mod):
    div_c_c = division.div_c_c
    f = epyc_division_mod.div_c_c
...
def test_call_div_i_c(epyc_division_mod):
    div_i_c = division.div_i_c
    f = epyc_division_mod.div_i_c
    x = randint(1e5)
    y = complex(uniform(low=1, high=1e2), uniform(low=1, high=1e2))
...
def test_call_div_c_i(epyc_division_mod):
    div_c_i = division.div_c_i
    f = epyc_division_mod.div_c_i
    x = complex(uniform(high=1e5), uniform(high=1e5))
...
def test_call_div_r_c(epyc_division_mod):
    div_r_c = division.div_r_c
    f = epyc_division_mod.div_r_c
    x = uniform(high=1e9)
    y = complex(uniform(low=1, high=1e2), uniform(low=1, high=1e2))
...
def test_call_div_c_r(epyc_division_mod):
    div_c_r = division.div_c_r
    f = epyc_division_mod.div_c_r
    x = complex(uniform(high=1e5), uniform(high=1e5))
    y = uniform(low=1e-14, high=1e3)
...
def test_call_fdiv_i_i_8(epyc_floor_division_mod):
    fdiv_i_i = epyccel_floor_division.fdiv_i_i_8
    f = epyc_floor_division_mod.fdiv_i_i_8
...
def test_call_fdiv_i_i_16(epyc_floor_division_mod):
    fdiv_i_i = epyccel_floor_division.fdiv_i_i_16
    f = epyc_floor_division_mod.fdiv_i_i_16
...
def test_call_fdiv_i_i_32(epyc_floor_division_mod):
    fdiv_i_i = epyccel_floor_division.fdiv_i_i_32
    f = epyc_floor_division_mod.fdiv_i_i_32
...
def test_call_fdiv_i_i_i(epyc_floor_division_mod):
    fdiv_i_i_i = epyccel_floor_division.fdiv_i_i_i
    f = epyc_floor_division_mod.fdiv_i_i_i
...
def test_call_fdiv_b_b(epyc_floor_division_mod):
    fdiv_b_b = epyccel_floor_division.fdiv_b_b
    f = epyc_floor_division_mod.fdiv_b_b
...
def test_call_fdiv_i_r(epyc_floor_division_mod):
    fdiv_i_r = epyccel_floor_division.fdiv_i_r
    f = epyc_floor_division_mod.fdiv_i_r
...
def test_call_fdiv_r_i(epyc_floor_division_mod):
    fdiv_r_i = epyccel_floor_division.fdiv_r_i
    f = epyc_floor_division_mod.fdiv_r_i
...
def test_call_fdiv_r_r(epyc_floor_division_mod):
    fdiv_r_r = epyccel_floor_division.fdiv_r_r
    f = epyc_floor_division_mod.fdiv_r_r
