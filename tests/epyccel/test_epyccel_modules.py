...
def test_module_6(language):
    ...
    atts = ("g", "R0", "rMin", "rMax", "skip_centre", "method", "compl", "tiny", "I")
    for att in atts:
...
@pytest.mark.parametrize(
    ...
    (
        pytest.param(
            ...
            marks=[
                pytest.mark.xfail(
                    reason="List wrapper is not implemented yet, related issue #1911"
                ),
                pytest.mark.fortran,
            ],
        ),
        pytest.param(
            ...
            marks=[
                pytest.mark.xfail(
                    reason="List indexing is not yet supported in C, related issue #1876"
                ),
                pytest.mark.c,
            ],
        ),
...
@pytest.mark.skipif(
    ...
    reason="PEP695 (type statement) implemented in Python 3.12",
)
