...
#==============================================================================
# INPUT DATA TYPE TO OTHER DATA TYPES
#==============================================================================
...
@template('T1', ['bool[:,:]', 'int[:,:]', 'int8[:,:]', 'int16[:,:]', 'int32[:,:]', 'int64[:,:]', 'float[:,:]', 'float32[:,:]', 'float64[:,:]', 'complex64[:,:]', 'complex128[:,:]'])
def src_dest_diff_sizes_dtype_convert_to_complex128(arr1 : 'T1', arr2 : 'T1', arr3 : 'T1'):
    from numpy import shape, array
    a = array(arr1)
    b = array(arr2)
    c = array(arr3)
...
@template('T1', ['bool[:,:]', 'int[:,:]', 'int8[:,:]', 'int16[:,:]', 'int32[:,:]', 'int64[:,:]', 'float[:,:]', 'float32[:,:]', 'float64[:,:]', 'complex64[:,:]', 'complex128[:,:]'])
def src_dest_diff_sizes_dtype_convert_to_complex128_orderF(arr1 : 'T1', arr2 : 'T1', arr3 : 'T1'):
    from numpy import shape, array
    a = array(arr1)
    b = array(arr2)
    c = array(arr3)
