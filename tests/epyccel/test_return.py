...
def test_create_arr(language):
    ...
    epyc_create_arr = epyccel(
        create_arr, language=language, flags="-Werror -Wunused-variable"
    )
...
def test_return_arr_element(language):
    ...
    epyc_return_arr_element = epyccel(
        return_arr_element, language=language, flags="-Werror -Wunused-variable"
    )
...
def test_create_multi_arrs(language):
    ...
    epyc_create_multi_arrs = epyccel(
        create_multi_arrs, language=language, flags="-Werror -Wunused-variable"
    )
...
def test_expr_arrs_elements(language):
    ...
    epyc_expr_arrs_elements = epyccel(
        expr_arrs_elements, language=language, flags="-Werror -Wunused-variable"
    )
...
def test_complex_expr(language):
    ...
    epyc_complex_expr = epyccel(
        complex_expr, language=language, flags="-Werror -Wunused-variable"
    )
...
def test_multi_allocs(language):
    ...
    epyc_multi_allocs = epyccel(
        multi_allocs, language=language, flags="-Werror -Wunused-variable"
    )
...
def test_arg_arr_element_op(language):
    ...
    epyc_return_mult_arr_arg_element = epyccel(
        return_mult_arr_arg_element,
        language=language,
    ...
    epyc_return_add_arr_arg_element = epyccel(
        return_add_arr_arg_element, language=language, flags="-Werror -Wunused-variable"
    )
    assert epyc_return_add_arr_arg_element(7, arr) == return_add_arr_arg_element(7, arr)
    epyc_return_op_arr_arg_element = epyccel(
        return_op_arr_arg_element, language=language, flags="-Werror -Wunused-variable"
    )
