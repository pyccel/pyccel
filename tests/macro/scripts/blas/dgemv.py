...
#$ header macro (double(y.shape[0], y.shape[1])) :: (y), _dgemv(alpha, a, x, y, t, beta=0, lda=a.shape[0], incx=1, incy=1) := dgemv(t, a.shape[0], a.shape[1], alpha, a, lda, x, incx, beta, y, incy)
